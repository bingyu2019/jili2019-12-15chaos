          ...
          <div class="container">
            ...
            <div class="tab-content">
              ...
              <div id="remind" class="container tab-pane active pb-5"><br>
                {{--我的提醒-关注的帖子有新回复--}}
                <div class="text-container container bottom-line">
                  <div>
                    <a href="">
                ...
                {{--我的提醒-发布的帖子有新回复--}}
                <div class="text-container container bottom-line mt-4">
                  <div>
                    <a href="">
                      <img class="round-avatar float-left"
                           src="https://cdn.learnku.com/uploads/avatars/46186_1564453747.jpeg!/both/400x400"
                ...
                <div class="text-container container bottom-line mt-4">
                  <div>
                    ...
                    <h5 class="float-left ml-4">发表的评论 　 <a href="" class="letter"> Laravel
                        7 的简单隐式路由模型绑定</a>　　有新回复</h5>
                    <h5 class="float-right text-dark">⊙10分钟前　　2019-12-11 12:54:08</h5>
                  </div>
                  <br>
