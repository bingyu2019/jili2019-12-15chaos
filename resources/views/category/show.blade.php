    ...
    <div class="d-none d-sm-block">
        ...
        <div class="root-nav row col-md-12">
            ...
            <div class="float-right">
                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<img
                    class=" img-fluid" src="/images/md/category-show.jpg">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="experience-title container mt-4 col-sm-11">
                <h3 class="text-white text-center pt-2">灵 &nbsp;&nbsp;魂&nbsp;&nbsp; 展&nbsp; &nbsp;览 &nbsp; 馆</h3>
            </div>
            {{-- 分类二级类别 --}}
            <div class="subclass myself-subclass  container col-sm-11">
                <ul class="show-subclass text-center pt-5 ">
                    <li class="float-left text-white">│ <a href=""> &nbsp;&nbsp;诗歌展 &nbsp; </a>│</li>
                    <li class="float-left text-white"><a href="">&nbsp; &nbsp;书画展&nbsp; </a>│</li>
                    <li class="float-left text-white"><a href="">&nbsp; &nbsp;摄影展&nbsp; </a>│</li>
                    <li class="float-left text-white"><a href="">&nbsp; &nbsp;设计展 &nbsp;</a>│</li>
                </ul>
            </div>
            {{-- 排序--}}
            ...
            <div class="order-title container col-sm-11">
                <ul class="navbar navbar-expand-lg text-center">
                    ...
                    <li class="text-center pr-3" style="width: 100px"><p>展号</p></li>
                    <li style="width: 350px"><p>标题</p></li>
                    <li class="pl-3" style="width: 150px"><p>创建者</p></li>
                    <li class="pl-2" style="width: 150px"><p>日期</p></li>
                    <li class="pl-2" style="width: 120px"><p>点赞</p></li>
                    <li class="pl-2" style="width: 120px"><p>参展</p></li>
                </ul>
            </div>
            {{-- 表格 --}}
