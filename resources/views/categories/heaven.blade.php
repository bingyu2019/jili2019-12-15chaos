    ...
    <div class="big-box mx-auto">
      ...
      <nav class="root-nav">
        ...
        <div class="float-left">
          &nbsp;&nbsp;&nbsp;<img class=" img-fluid" src="/images/category/md-heaven.png">
        </div>
      </nav>
=======
    {{-- ================= 灵魂极乐-电脑版 ====================== --}}
        ...
        <div class="big-box mx-auto">
            ...
            <nav class="root-nav row col-md-12">
                ...
                <div class="float-right">
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;<img
                        class=" img-fluid" src="/images/category/md-heaven.png">
                </div>
            </nav>
                    ...
                    <div class="order container navbar navbar-expand-lg col-sm-11"
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 60px;"><a href="">留赞</a> &nbsp;▆</td>
                                <td style="width: 60px;"><a href="">献礼</a> &nbsp;▆</td>
                                <td style="width: 60px;"><a href="">悼念</a> &nbsp;▆</td>
...
>>>>>>> 442a44c6a47968f692b67a6ff60c63ef6c68f327
  ...
  <div class="d-block d-sm-none">
    ...
    <header>
      ...
      {{-- 分类名称 --}}
      <div>
        <h3 class="text-center text-white">❖ 灵魂极乐 ❖</h3>
        <br>
