        ...
        <div class="big-box mx-auto">
            ...
            <nav class="root-nav row col-md-12">
                ...
                <div class="float-right">
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;<img
                        class=" img-fluid" src="/images/category/md-show.jpg">
                </div>
            </nav>
            ...
            <section>
                ...
                <div>
                    ...
                    <div class="experience-title container mt-4 col-sm-11">
                        <h3 class="text-white text-center pt-2">灵 &nbsp;&nbsp;魂&nbsp;&nbsp; 展&nbsp; &nbsp;览 &nbsp;
                            馆</h3>
                    </div>
                    {{-- 分类二级类别 --}}
                    ...
                    <div class="order container navbar navbar-expand-lg col-sm-11"
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 60px;"><a href="">最新</a> &nbsp;▆</td>
                                ...
                                <td style="width: 60px;"><a href="">参展</a> &nbsp;▆</td>
...
>>>>>>> 442a44c6a47968f692b67a6ff60c63ef6c68f327
      ...
      <nav class="root-nav">
        ...
        <div class="float-left">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;<img class=" img-fluid" src="/images/category/md-show.jpg">
        </div>
      </nav>
