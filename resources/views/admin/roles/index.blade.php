@extends('layouts.app')
@section('title',Auth::user()->name.'管理角色')
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;">
      <h3 class="text-center pb-4 pt-2">角 色 列 表</h3>
      <a href="{{ route('admin.roles.create') }}" class="btn btn-success float-right mr-5" role="button" aria-pressed="true" style="width: 130px;">新增角色</a>
    ...
    <form action="">
      <table class="table table-bordered table-hover mt-2 admin-all-index">
        ...
        <tr class="card-header" style="font-size: 18px;">
          ...
          <th scope="col" style="width: 150px;">角色</th>
          <th scope="col">权限</th>
          <th scope="col" style="width: 200px;">编辑日期</th>
          <th scope="col" style="width: 80px;">操作者</th>
        ...
        <tr class="pb-2">
          ...
          <td>1</td>
          <td>Founder</td>
          <td>站点设置 修改、删除、审核用户 修改、删除、审核帖子 财务管理 允许查看财务 允许前台修改、删除、审核贴子 系统管理 市场营销</td>
          <td>2019-12-05 12:12:12</td>
          <td>Bing</td>
          <td>正常</td>
          <td><a href="{{ route('admin.roles.edit') }}" class="btn btn-success btn-sm">编辑</a> <a href=""
        ...
        <tr class="pb-2">
          ...
          <td>3</td>
          <td>财务</td>
          <td>记录计算处理财务的收入与支出 允许查看财务 市场营销</td>
          <td>2019-12-05 12:12:12</td>
          <td>Bing</td>
          <td>正常</td>
          <td><a href="{{ route('admin.roles.edit') }}" class="btn btn-success btn-sm">编辑</a> <a href=""
        ...
        <tr class="pb-2">
          ...
          <td>4</td>
          <td>管理员</td>
          <td>修改、删除、审核帖子 允许查看财务 允许前台修改、删除、审核贴子 市场营销</td>
          <td>2019-12-05 12:12:12</td>
          <td>Bing</td>
          <td>正常</td>
          <td><a href="{{ route('admin.roles.edit') }}" class="btn btn-success btn-sm">编辑</a> <a href=""
        ...
        <tr class="pb-2">
          ...
          <td>5</td>
          <td>总编辑</td>
          <td>修改、删除、审核帖子 财务管理 允许前台修改、删除、审核贴子 市场营销</td>
          <td>2019-12-05 12:12:12</td>
          <td>Bing</td>
          <td>正常</td>
          <td><a href="{{ route('admin.roles.edit') }}" class="btn btn-success btn-sm">编辑</a> <a href=""
