...
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;">
      <h3 class="text-center pb-4 pt-2">图 片 列 表</h3>
      ...
      <form class="form-inline my-2 my-lg-0 float-right mr-5">
        <input class="form-control mr-sm-2" type="search" placeholder="帖子ID" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">筛选</button>
      </form>
    </div>
    ...
    <form action="">
      <table class="table table-bordered table-hover mt-2 admin-all-index">
        ...
        <tr class="pb-2">
          ...
          <td>1</td>
          <td><a href=""><img src="/images/avatar/face100px.jpg"
                              class="img-thumbnail "
                              alt="Cinque Terre"
                              style="width: 60px;"></a></td>
          <td>222</td>
          <td>IT</td>
          <td>区块链专利申请井喷 能否获利尚待授权检验</td>
          <td>Bing</td>
