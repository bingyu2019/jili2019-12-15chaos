...
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;background: #FFF0F5;">
      <h3 class="text-center pb-4 pt-2">管 理 员 列 表</h3>
      <a href="{{ route('admin.admin.create') }}" class="btn btn-success float-right mr-5" role="button" aria-pressed="true" style="width: 130px;">添加管理员</a>
