...
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;">
      <h3 class="text-center pb-4 pt-2">🎁礼 赞 列 表🎁</h3>
      ...
      <form class="form-inline my-2 my-lg-0 float-right mr-5">
        <input class="form-control mr-sm-2" type="search" placeholder="礼赞日期" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">筛选</button>
      </form>
      <form class="form-inline my-2 my-lg-0 float-right mr-5">
        <input class="form-control mr-sm-2" type="search" placeholder="礼赞者" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">筛选</button>
      </form>
      <form class="form-inline my-2 my-lg-0 float-right mr-5">
        <input class="form-control mr-sm-2" type="search" placeholder="礼赞内容" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">筛选</button>
      </form>
    </div>
    ...
    <form action="">
      <table class="table table-bordered table-hover mt-2 admin-all-index">
        ...
        <tr class="card-header" style="font-size: 18px;">
          ...
          <th scope="col">🎁ID</th>
          <th scope="col">🎁礼赞者</th>
          <th scope="col">🎁礼赞的内容</th>
          <th scope="col">🎁礼赞金额</th>
          <th scope="col" style="width: 160px;">🎁礼赞日期</th>
          <th scope="col">🎁受礼赞人</th>
        </tr>
        </thead>
        <tbody>
        <tr class="pb-2">
