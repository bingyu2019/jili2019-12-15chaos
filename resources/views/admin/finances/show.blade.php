...
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;">
      <h3 class="text-center pb-4 pt-2">展 览 列 表</h3>
    ...
    <form action="">
      <table class="table table-bordered table-hover mt-2 admin-all-index">
        ...
        <tr class="card-header" style="font-size: 18px;">
          ...
          <th scope="col">参展人数</th>
          <th scope="col">参展费用/人/天</th>
        ...
        <tr class="pb-2">
          ...
          <td>未发放</td>
          <td>200 元</td>
          <td><a href="{{ route('admin.finances.showEdit') }}" class="btn btn-success btn-sm">编辑</a>
          </td>
        </tr>
        <tr class="pb-2">
          <td>1</td>
