...
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;">
      ...
      <button type="button" class="btn btn-success float-right mr-5" data-toggle="button" aria-pressed="false"
    ...
    <form action="">
      <table class="table table-bordered table-hover mt-2">
        ...
        <tr class="pb-2">
          ...
          <td>1</td>
          <td><img src="{{ Auth::user()->avatar }}" style="width: 40px;height: 40px;" alt="头像"></td>
          <td>冰之骄女</td>
          ...
          <td>1234</td>
          <td>正常</td>
          <td><a href="" class="btn btn-success btn-sm">编辑</a> <a href="" class="btn btn-danger btn-sm">删除</a></td>
        </tr>
        </tbody>
      </table>
      <br>
