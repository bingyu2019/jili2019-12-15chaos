...
@section('content')
  ...
  <div class="card col-md-12 pt-1">
    <div class="card-header" style="border-radius: 5px; border: solid 3px #E7E6ED;border-bottom: none;">
      <h3 class="text-center pb-4 pt-2">帖 子 列 表</h3>
      <a href="{{ route('admin.topics.create') }}" class="btn btn-success float-right mr-5" role="button" aria-pressed="true" style="width: 130px;">新增帖子</a>
      ...
      <form class="form-inline my-2 my-lg-0 float-right mr-5">
        <input class="form-control mr-sm-2" type="search" placeholder="作者" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">筛选</button>
      </form>
      <form class="form-inline my-2 my-lg-0 float-right mr-5">
    ...
    <form action="">
      <table class="table table-bordered table-hover mt-2 admin-all-index">
        ...
        <tr class="pb-2">
          ...
          <td>已发布</td>
          <td><a href="{{ route('admin.topics.edit') }}" class="btn btn-success btn-sm">编辑</a> <a href=""
